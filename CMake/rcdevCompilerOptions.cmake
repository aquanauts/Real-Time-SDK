...
if( UNIX )
	...
	if ( ${CMAKE_BUILD_TYPE} STREQUAL "Optimized" )
		set ( CMAKE_C_FLAGS "${RCDEV_C_FLAGS_INIT} -DNDEBUG -O3 -ggdb3 -fbuiltin ${CMAKE_FLAGS_CLANG}" CACHE STRING "" FORCE)
	...
	if ( ${CMAKE_BUILD_TYPE} STREQUAL "Optimized" )
		set ( CMAKE_CXX_FLAGS "${RCDEV_CXX_FLAGS_INIT} -DNDEBUG -O3 -ggdb3 -fbuiltin ${CMAKE_FLAGS_CLANG}" CACHE STRING ""  FORCE)
	elseif ( ${CMAKE_BUILD_TYPE} STREQUAL "Debug" )
